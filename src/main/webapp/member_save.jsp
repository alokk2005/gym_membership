...
%>
        ...
        <p class="message-text">The member has been successfully added to the system.</p>
        <div class="btn-container">
            <a class="btn-link" href="member_list.jsp">View Members</a>
            <a class="btn-link btn-secondary" href="member_register.jsp">Add Another</a>
        </div>
<%
    } else {
%>
        ...
        <p class="message-text">An error occurred while registering the member. Please try again.</p>
        <div class="btn-container">
