...
%>
        ...
        <p class="message-text">The payment has been successfully saved to the system.</p>
        <div class="btn-container">
            <a class="btn-link" href="payment_history.jsp">View Payment History</a>
            <a class="btn-link btn-secondary" href="payment_add.jsp">Add Another</a>
        </div>
<%
    } else {
%>
        ...
        <p class="message-text">An error occurred while saving the payment. Please try again.</p>
        <div class="btn-container">
