...
<style>
    * {
    ...
    /* Plan badge for different plan types */
    .plan-badge {
...
<%
    try {
        ...
        while (rs.next()) {
            ...
            String badgeClass = "plan-badge ";

            if (planName.toLowerCase().contains("monthly")) {
                badgeClass += "badge-monthly";
            } else if (planName.toLowerCase().contains("annual")) {
                badgeClass += "badge-annual";
            } else if (planName.toLowerCase().contains("premium")) {
                badgeClass += "badge-premium";
            } else if (planName.toLowerCase().contains("class")) {
...
%>
                    <tr>
                        ...
                        <td><span class="<%= badgeClass %>"><%= planName %></span></td>
...
%>
                    <tr>
                        <td colspan="5" class="empty-state">No plans found. Start by adding a new subscription plan!</td>
                    </tr>
<%
        }
